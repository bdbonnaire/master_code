...
void Current::print(std::ostream &o)
{
	o << " *** Current Account *** \n";
	Account::print(o);
}
...
void Savings::print(std::ostream &o)
{
	Account::print(o);
	o << "Interest Rate : " << interest_rate << "\n";
}
...
void Blocked::print(std::ostream &o)
{
...
void Unblocked::print(std::ostream &o)
{
